...
import type { Metadata, ResolvedMetadata } from './nextjs/types/metadata-interface';
...
export function resolveMetadata(...metadata: [MetadataWithPathname, ...MetadataWithPathname[]]) {
